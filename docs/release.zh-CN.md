...
```powershell
pnpm release:json -- --tag v0.2.10 --notes "更新说明（可选）"
```
...
```json
{
  ...
  "platforms": {
    "windows-x86_64": {
      "url": "https://github.com/rururunu/Anya/releases/download/v0.2.10/Anya_0.2.10_x64.msi",
      "signature": "<Anya_0.2.10_x64.msi.sig 文件的全部内容>"
    }
  }
}
```
